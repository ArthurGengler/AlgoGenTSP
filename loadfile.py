...
Arthur3v2_25 = np.load('Arthur/Breed25_pop100_it5000.npy',allow_pickle=True)
...
distArthur3v2_25=Arthur3v2_25[0,:]
...
data_a = [distArthur1_25, distArthur2_25,distInternet_25,distmodulebuild_50, distArthur3_25]

ticks = ['Single', 'PMX', 'CodeFound1','CodeFound2', 'OrderedModified']
...
Arthur1_50 = np.load('Arthur/SinglePoint50.npy',allow_pickle=True)
Arthur2_50 = np.load('Arthur/PMX50.npy',allow_pickle=True)
Arthur3_50 = np.load('Arthur/Breed50.npy',allow_pickle=True)
Arthur3v2_50 = np.load('Arthur/Breed50_pop100_it10000.npy',allow_pickle=True)
Arthur4_50 = np.load('Arthur/NewPMX50.npy',allow_pickle=True)

Internet_50 = np.load('Arthur/Internet50.npy',allow_pickle=True)
modulebuild_50 = np.load('Arthur/prebuildmodule50.npy',allow_pickle=True)
modulebuildv2_50 = np.load('Arthur/prebuildmodule50_pop100_it10000.npy',allow_pickle=True)

distArthur1_50=Arthur1_50[0,:]
distArthur2_50=Arthur2_50[0,:]
distArthur3_50=Arthur3_50[0,:]
distArthur3v2_50=Arthur3v2_50[0,:]
distArthur4_50=Arthur4_50[0,:]
distInternet_50 =Internet_50[0,:]
distmodulebuild_50=modulebuild_50[0,:]
distmodulebuildv2_50=modulebuildv2_50[0,:]
data_a = [distArthur3v2_50,distInternet_50,distmodulebuildv2_50]

ticks = ['OrderedModified','CodeFound1','CodeFound2']
...
Arthur3_100 = np.load('Arthur/newordered100.npy',allow_pickle=True)
Arthur3v2_100 = np.load('Arthur/newordered100_pop200_iteration_15000.npy',allow_pickle=True)#1500 iterations, 200 pop

modulebuild_100 = np.load('Arthur/prebuildmodule100.npy',allow_pickle=True)
modulebuildv2_100 = np.load('Arthur/prebuildmodule100_pop200.npy',allow_pickle=True)#1500 iterations, 200 pop


Mat100 = np.load('Matthias/TTH2_TSP_n100_1_vACO_cycle__max_nb_rounds_1000__alpha_1__beta_2__rho_0.5__Q_100__eps_0.001.npy',allow_pickle=True)

distMat100 = Mat100[:,1]
distArthur3_100=Arthur3_100[0,:]
distArthur3_100v2=Arthur3v2_100[0,:]
distmodulebuild_100=modulebuild_100[0,:]
distmodulebuildv2_100=modulebuildv2_100[0,:]
data_a = [ distArthur3_100v2, distmodulebuildv2_100]

ticks = ['OrderedModified','CodeFound2' ]
...
Matthias50 = np.load('Matthias/TTH2_TSP_n50_1_vACO_cycle__max_nb_rounds_1000__alpha_1__beta_2__rho_0.5__Q_100__eps_0.001.npy',allow_pickle=True)
Matthias100 = np.load('Matthias/TTH2_TSP_n100_1_vACO_cycle__max_nb_rounds_1000__alpha_1__beta_2__rho_0.5__Q_100__eps_0.001.npy',allow_pickle=True)

print(Mat25[:,1])
data_a = [Mat25[:,1], distArthur3_25, Matthias50[:,1], distArthur3_50,Matthias100[:,1], distArthur3_100v2]

ticks = ['Matthias25','Arthur25','Matthias50','Arthur50','Matthias100','Arthur100' ]
